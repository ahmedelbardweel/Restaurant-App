  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => showCreateRestaurantDialog(context: context, onSuccess: _fetchRestaurants),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () => showRestaurantOptionsSheet(context: context, restaurant: res, onDeleteSuccess: _fetchRestaurants),
                              ),
                            ],
                          ),
                        ),
